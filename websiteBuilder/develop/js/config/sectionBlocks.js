    ...
    content: `<nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <section id="hero" class="d-flex flex-column align-items-center justify-content-center pt-4">
        ...
        <div class="hero-image p-4 bg-white shadow-sm rounded">
          <img src="https://res.cloudinary.com/dpnea22ek/image/upload/c_scale,q_100,w_1400/v1627100771/gramateria.jpg" alt="websiteBuilder">
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="d-flex justify-content-center flex-column p-4">
              ...
              <p class="subtitle">with websiteBuilder page builder</p>
              <div class="buttons">
        ...
        <div class="row mt-5">
          <div class="col-12">
            <p class="text-center text-muted">
              <small>&copy; 2019-2021 | websiteBuilder | All Rights Reserved.</small>
            </p>
          </div>
        </div>
      </div>
